...
public class LocationConstants {
    ...
    public static final String DB_LOCATION_CITY = "Novi Sad";
    public static final String DB_LOCATION_CITY_AREA = null;
    public static final String DB_LOCATION_STREET = "Mileve Maric";
